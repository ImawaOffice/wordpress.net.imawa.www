...
$count = 0;
$html = '';
$filterAttributes = ['product_cat' => 'Category', 'ID' => 'Product Id', '_stock_status' => 'Stock Status'];
if ($filters !== '') {
    $count = 0;
...
<script>
    ...
    jQuery(document).ready(function () {        
        ...
        jQuery(document).on('click', '.filteredProductSyn', function (e) {            
            ...
            if (!jQuery.isEmptyObject(productArray) || !jQuery.isEmptyObject(exclude) || (thisVal == 'syncAll' && jQuery('.syncProduct').is(':checked')) || !jQuery.isEmptyObject(include)) {
